...
//var url1 ='http://localhost:6010/';

var url1 ='https://mhpspm3.mybluemix.net/';
...
{
	var equipment = responseContext.Equipment;//boiler..turbine
	var p_name = responseContext.P_NAME;//name of the project Proto-C
   var issue_name = responseContext.ISSUE_NAME;//occurance .. horizon deployment
    var pending_issue = responseContext.PENDING_ISSUE;//pending issue

	 console.log(p_name,equipment,issue_name,pending_issue);
...

{
    ...
    var occurance = responseContext.OCCURANCE;//pending issue
...
console.log('query is',FetchQuery);
      ...
      success: function(data) {
		  ...
		  if(data.length ==0)
		  {
			  ...
			  $("#timeStamp").append("<div class='direct-chat-msg doted-border'><div class='direct-chat-info clearfix'><span class='direct-chat-name pull-left'><img style='margin-left: -58px;width: 54px;border-radius: 55%;' src='Capture.PNG' alt='User Avatar' class='img-circle' /></span></div><div style='margin-top: -40px' class='direct-chat-text'>" +'Sorry, there are no Pendign Isssue due to this reason, kinldy ask another ocucrance.'+ "</div><div id='timeStamp' class='direct-chat-info clearfix'><span id='time' class='direct-chat-timestamp pull-right'>" +formatted5+ "</span></div></div>");
...
FetchQuery ="SELECT  P_NAME ,PENDING_ISSUE,PENDING_ISSUE_DETAIL, PROCESSING_STATUS,DATE_OF_OCCURANCE,PROCESSING_DEADLINE,PROCESSING_STATUS1,COMPLETION_DATE,CAUSE_OF_OCCURANCE,PENDING_ISSUE_STATUS,ACTUAL_VALUE,COST_RESPONSIBILITY_DEVISION,COST_RANGE,COST_CATEGORY,COST_FOLLOW_UP,PROBABILITY_OF_OCCURNACE ,SCHEDULE_IMPACT ,COMPLAINT_HANDLING FROM  MHPSJPUC311 where PENDING_ISSUE LIKE  '%"+ equipment +"%' AND P_NAME ='" + p_name + "' AND OCCURANCE ='"+ issue_name+"' AND PENDING_ISSUE = '"+ pending_issue + "'";
      ...
      success: function(data) {
		  ...
		  x+='<detail><summary>first project details</summary>'
		    x+='<details> <summary>Project Name</summary> <p>' +  data[0].P_NAME + '</p></details>'
			+'<details> <summary>PENDING_ISSUE</summary> <p>' + data[0].PENDING_ISSUE + '</p></details>'
			+'<details> <summary>PENDING_ISSUE_DETAIL</summary> <p>' +  data[0].PENDING_ISSUE_DETAIL + '</p></details>'
			+'<details> <summary>PROCESSING_STATUS</summary> <p>' + data[0].PROCESSING_STATUS + '</p></details>'
			+'<details> <summary>DATE_OF_OCCURANCE</summary> <p>' +  data[0].DATE_OF_OCCURANCE + '</p></details>'
			+'<details> <summary>PROCESSING_DEADLINE</summary> <p>' + data[0].PROCESSING_DEADLINE+ '</p></details>'
			+'<details> <summary>PROCESSING_STATUS1</summary> <p>' +  data[0].PROCESSING_STATUS1 + '</p></details>'
			+'<details> <summary>COMPLETION_DATE</summary> <p>' + data[0].COMPLETION_DATE + '</p></details>'
			+'<details> <summary>CAUSE_OF_OCCURANCE</summary> <p>' +  data[0].CAUSE_OF_OCCURANCE + '</p></details>'
			+'<details> <summary>PENDING_ISSUE_STATUS</summary> <p>' + data[0].PENDING_ISSUE_STATUS + '</p></details>'
            +'<details> <summary>ACTUAL_VALUE</summary> <p>' +  data[0].ACTUAL_VALUE + '</p></details>'
			+'<details> <summary>COST_RESPONSIBILITY_DEVISION</summary> <p>' + data[0].COST_RESPONSIBILITY_DEVISION + '</p></details>'
			+'<details> <summary>COST_RANGE</summary> <p>' +  data[0].COST_RANGE + '</p></details>'
			+'<details> <summary>COST_CATEGORY</summary> <p>' + data[0].COST_CATEGORY + '</p></details>'
			+'<details> <summary>COST_FOLLOW_UP</summary> <p>' +  data[0].COST_FOLLOW_UP + '</p></details>'
			+'<details> <summary>PROBABILITY_OF_OCCURNACE</summary> <p>' + data[0].PROBABILITY_OF_OCCURNACE + '</p></details>'
			+'<details> <summary>SCHEDULE_IMPACT</summary> <p>' +  data[0].SCHEDULE_IMPACT + '</p></details>'
			+'<details> <summary>COMPLAINT_HANDLING</summary> <p>' + data[0].COMPLAINT_HANDLING + '</p></details>'
			+'</detail>'
